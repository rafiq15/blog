                        ...
                        <ul class="post-icons">
                            <li>
                                ...
                                <a href="javascript:void(0);" onclick="
                                        document.getElementById('favorite-post-{{$post->id}}').submit();"
                                    class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$post->id)->count()  == 0 ? 'favorite_posts' : ''}}">
                                    <i class="ion-heart"></i>
                                    {{ $post->favorite_to_users->count()}}
                                </a>
                                <form id="favorite-post-{{$post->id}}" action="{{ route('post.favorite', $post->id) }}"
                            ...
                            <ul class="post-footer">
                                <li>
                                    ...
                                    <a href="javascript:void(0);"
                                        onclick="
                                                    document.getElementById('favorite-post-{{$randomPost->id}}').submit();"
                                        class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$randomPost->id)->count()  == 0 ? 'favorite_posts' : ''}}">
                                        <i class="ion-heart"></i>
                                        {{ $randomPost->favorite_to_users->count()}}
                                    </a>
                                    <form id="favorite-post-{{$randomPost->id}}"
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="comment-form">
                    @guest
                        <p>For post new comment please login first
